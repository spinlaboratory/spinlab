...
class ABCData(object):
    ...
    @property
    def real(self):
        """SpinData: SpinData with real part of values"""
        a = self.copy()
    ...
    @property
    def imag(self):
        """SpinData: SpinData with imaginary part of values"""
        a = self.copy()
    ...
    @property
    def abs(self):
        """SpinData: SpinData with absolute part of values"""
        a = self.copy()
    ...
    def __array_ufunc__(self, ufunc, method, *arrInput, **kwargs):
        ...
        if method == "__call__":
            ...
            if kwargs.pop("_spinlab_inplace", False):
                a = self
            else:
                a = self.copy()
            a.values = values
    ...
    def __array_function__(self, func, types, args, kwargs):
        ...
        if type(return_values) == _np.ndarray:
            ...
            if kwargs.pop("_spinlab_supress_attr", False):
                return a
