...
class load_wrapper_tester(unittest.TestCase):
    ...
    def test_topspin(self):
        data = sl.load(os.path.join(self.topspin_dir, str(1)), data_format="topspin")
    ...
    def test_prospa(self):
        sl.load(os.path.join(self.prospa_dir, str(1), "data.csv"), data_format="prospa")

    def test_vnmrj(self):
        sl.load(self.vnmrj_dir, data_format="vnmrj")
