...
class sl_processing_tester(unittest.TestCase):
    ...
    def test_000_integration_regions(self):
        ...
        integralHalf = sl.processing.integrate(self.data, 'x0', regions = (0.,1.) )
        integralHalf2 = sl.processing.integrate(self.data, 'x0', regions = [(0.,1.)] )
        ...
        integral2 = sl.processing.integrate(self.data, 'x0', regions = [(0.,0.5),(1,2.0)] )
